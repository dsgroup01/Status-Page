    ...
    <div id="footerwrap">
      <div class="container">
        <div class="row centered">
          <div class="col-md-4 text-left">Copyright © 2016-<?php echo date("Y");?> DS Group</div>
          ...
          <div> By <a href="//dsgroup.eu.org" target="_blank">DS Group</a></div>
		  <div class="col-md-4 text-right"><a href="https://github.com/dsgroup01/Status-Page" target="_blank"><i class="fab fa-github" aria-hidden="true"></i></a></div>
        </div><!--/row -->
      </div><!--/container -->
    </div>
